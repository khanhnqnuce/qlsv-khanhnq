...
namespace FDI.Base
{
    ...
    public partial class FDIEntities : DbContext
    {
        ...
        public DbSet<Advertising_Zone> Advertising_Zone { get; set; }
        ...
        public DbSet<Gallery_Album> Gallery_Album { get; set; }
        public DbSet<Gallery_Category> Gallery_Category { get; set; }
        public DbSet<Gallery_Picture> Gallery_Picture { get; set; }
        public DbSet<Gallery_Video> Gallery_Video { get; set; }
        public DbSet<Guide_Category> Guide_Category { get; set; }
        public DbSet<Guide_Guide> Guide_Guide { get; set; }
        public DbSet<HtmlSetting> HtmlSettings { get; set; }
        ...
        public DbSet<Shop_Brand> Shop_Brand { get; set; }
        public DbSet<Shop_Category> Shop_Category { get; set; }
        public DbSet<Shop_Category_Tag_Mapping> Shop_Category_Tag_Mapping { get; set; }
        public DbSet<Shop_Comment> Shop_Comment { get; set; }
        public DbSet<Shop_Comment_BadKey> Shop_Comment_BadKey { get; set; }
        public DbSet<Shop_CommentLike> Shop_CommentLike { get; set; }
        public DbSet<Shop_CommentReport> Shop_CommentReport { get; set; }
        public DbSet<Shop_Content> Shop_Content { get; set; }
        public DbSet<Shop_Label> Shop_Label { get; set; }
        public DbSet<Shop_Log_System> Shop_Log_System { get; set; }
        public DbSet<Shop_Order_ProductVariant> Shop_Order_ProductVariant { get; set; }
        public DbSet<Shop_Product> Shop_Product { get; set; }
        public DbSet<Shop_Product_Attribute> Shop_Product_Attribute { get; set; }
        public DbSet<Shop_Product_Attribute_Specification> Shop_Product_Attribute_Specification { get; set; }
        public DbSet<Shop_Product_Compatible_Accessories> Shop_Product_Compatible_Accessories { get; set; }
        public DbSet<Shop_Product_Group_Attribute> Shop_Product_Group_Attribute { get; set; }
        public DbSet<Shop_Product_PreOrder> Shop_Product_PreOrder { get; set; }
        public DbSet<Shop_Product_RateNumber> Shop_Product_RateNumber { get; set; }
        public DbSet<Shop_Product_RateType> Shop_Product_RateType { get; set; }
        public DbSet<Shop_Product_Rating> Shop_Product_Rating { get; set; }
        public DbSet<Shop_Product_Ref> Shop_Product_Ref { get; set; }
        public DbSet<Shop_Product_Review> Shop_Product_Review { get; set; }
        public DbSet<Shop_Product_ReviewMapping> Shop_Product_ReviewMapping { get; set; }
        public DbSet<Shop_Product_Search_Mapping> Shop_Product_Search_Mapping { get; set; }
        public DbSet<Shop_Product_Type> Shop_Product_Type { get; set; }
        public DbSet<Shop_Product_Variant> Shop_Product_Variant { get; set; }
        public DbSet<Shop_Product_Variant_Picture_Mapping> Shop_Product_Variant_Picture_Mapping { get; set; }
        public DbSet<Shop_Product_Variant_Recurring> Shop_Product_Variant_Recurring { get; set; }
        public DbSet<Shop_Promote_File> Shop_Promote_File { get; set; }
        public DbSet<Shop_Promotion_Product> Shop_Promotion_Product { get; set; }
        public DbSet<Shop_Promotion_Product_Variant> Shop_Promotion_Product_Variant { get; set; }
        public DbSet<Shop_Survey_Answer> Shop_Survey_Answer { get; set; }
        public DbSet<Shop_Survey_Product> Shop_Survey_Product { get; set; }
        public DbSet<Shop_Survey_Question> Shop_Survey_Question { get; set; }
        ...
        public virtual ObjectResult<aspnet_Membership_GetPassword_Result1> aspnet_Membership_GetPassword(string applicationName, string userName, Nullable<int> maxInvalidPasswordAttempts, Nullable<int> passwordAttemptWindow, Nullable<System.DateTime> currentTimeUtc, string passwordAnswer)
        {
            var applicationNameParameter = applicationName != null ?
                new ObjectParameter("ApplicationName", applicationName) :
                new ObjectParameter("ApplicationName", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<aspnet_Membership_GetPassword_Result1>("aspnet_Membership_GetPassword", applicationNameParameter, userNameParameter, maxInvalidPasswordAttemptsParameter, passwordAttemptWindowParameter, currentTimeUtcParameter, passwordAnswerParameter);
        }
    
        public virtual ObjectResult<aspnet_Membership_GetPasswordWithFormat_Result1> aspnet_Membership_GetPasswordWithFormat(string applicationName, string userName, Nullable<bool> updateLastLoginActivityDate, Nullable<System.DateTime> currentTimeUtc)
        {
            var applicationNameParameter = applicationName != null ?
                new ObjectParameter("ApplicationName", applicationName) :
                new ObjectParameter("ApplicationName", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<aspnet_Membership_GetPasswordWithFormat_Result1>("aspnet_Membership_GetPasswordWithFormat", applicationNameParameter, userNameParameter, updateLastLoginActivityDateParameter, currentTimeUtcParameter);
        }
        ...
        public virtual ObjectResult<aspnet_Membership_GetUserByName_Result1> aspnet_Membership_GetUserByName(string applicationName, string userName, Nullable<System.DateTime> currentTimeUtc, Nullable<bool> updateLastActivity)
        {
            var applicationNameParameter = applicationName != null ?
                new ObjectParameter("ApplicationName", applicationName) :
                new ObjectParameter("ApplicationName", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<aspnet_Membership_GetUserByName_Result1>("aspnet_Membership_GetUserByName", applicationNameParameter, userNameParameter, currentTimeUtcParameter, updateLastActivityParameter);
        }
    
        public virtual ObjectResult<aspnet_Membership_GetUserByUserId_Result1> aspnet_Membership_GetUserByUserId(Nullable<System.Guid> userId, Nullable<System.DateTime> currentTimeUtc, Nullable<bool> updateLastActivity)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<aspnet_Membership_GetUserByUserId_Result1>("aspnet_Membership_GetUserByUserId", userIdParameter, currentTimeUtcParameter, updateLastActivityParameter);
        }
        ...
        public virtual ObjectResult<aspnet_Profile_GetProperties_Result1> aspnet_Profile_GetProperties(string applicationName, string userName, Nullable<System.DateTime> currentTimeUtc)
        {
            var applicationNameParameter = applicationName != null ?
                new ObjectParameter("ApplicationName", applicationName) :
                new ObjectParameter("ApplicationName", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<aspnet_Profile_GetProperties_Result1>("aspnet_Profile_GetProperties", applicationNameParameter, userNameParameter, currentTimeUtcParameter);
        }
        ...
        public virtual ObjectResult<aspnet_UsersInRoles_RemoveUsersFromRoles_Result1> aspnet_UsersInRoles_RemoveUsersFromRoles(string applicationName, string userNames, string roleNames)
        {
            var applicationNameParameter = applicationName != null ?
                new ObjectParameter("ApplicationName", applicationName) :
                new ObjectParameter("ApplicationName", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<aspnet_UsersInRoles_RemoveUsersFromRoles_Result1>("aspnet_UsersInRoles_RemoveUsersFromRoles", applicationNameParameter, userNamesParameter, roleNamesParameter);
        }
